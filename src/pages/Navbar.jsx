      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {user && (
              <>
                <Link to="/profile" className="text-gray-100 hover:text-amber-400 block px-3 py-2 rounded-md text-base font-medium">Profile</Link>
                <Link to="/settings" className="text-gray-100 hover:text-amber-400 block px-3 py-2 rounded-md text-base font-medium">Settings</Link>
                <button
                  onClick={handleLogout}
            ...
            {!user && (
              <>
                <Link to="/signin" className="text-gray-100 hover:text-amber-400 block px-3 py-2 rounded-md text-base font-medium">Login</Link>
                <Link to="/signup" className="block px-3 py-2 rounded-md text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">Get Started</Link>
              </>
            )}
          </div>
        </div>
